		...
		while(true){
			...
			if(!empty($datas)){
				foreach($datas as $data){
					ProcessManager::getInstance()->getRpcCall(DeviceUpHandleChildProcess::class,false,DeviceUpHandleChildProcess::NAME . rand(1,$this->config->get('public.process.upinfo.child_num')))->handleData($data);
				}
			}else{
